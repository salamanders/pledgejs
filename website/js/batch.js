...
/* Testing
let batch = new ThrottledBatch(3, 5000);
batch.add(gapi.client.sheets.spreadsheets.get({'spreadsheetId': 'abc'}));
batch.add(gapi.client.sheets.spreadsheets.get({'spreadsheetId': 'abc'}), 11);
batch.add(gapi.client.sheets.spreadsheets.get({'spreadsheetId': 'abc'}), 12);
batch.add(gapi.client.sheets.spreadsheets.get({'spreadsheetId': 'abc'}));
batch.add(gapi.client.sheets.spreadsheets.get({'spreadsheetId': 'abc'}));
batch.add(gapi.client.sheets.spreadsheets.get({'spreadsheetId': 'abc'}));
batch.add(gapi.client.sheets.spreadsheets.get({'spreadsheetId': 'abc'}));
